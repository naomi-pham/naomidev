import { IconEmail, IconResume, IconWeb } from "~/components/common/Icons";
...
export const AboutLinks = [
  ...
  {
    id: 2,
    icon: <IconWeb size={21} />,
    label: "Articles",
    url: "/articles",
    linkText: "Read my works",
    isExternal: false,
  },
];
...
export const WritingPortfolioData = [
  {
    ...
    title: "How to Create Dark/Light Mode with React (Tailwind Styling)",
    publication: "Dev.to",
    image: "/writing.png",
    postLink:
  ...
  //   title: "How to Create A Glassmorphic Playlist with HTML/CSS and JavaScript",
  //   publication: "Dev.to",
  //   image: "/writing.png",
  //   postLink:
